...
public:
    ...
    BLACKBONE_API ptr_t peb32( _PEB32* ppeb = nullptr ) { return _native->getPEB( ppeb ); }
    ...
    /// <returns>PEB pointer</returns>
    BLACKBONE_API ptr_t peb64( _PEB64* ppeb = nullptr ) { return _native->getPEB( ppeb ); }
    ...
    ptr_t peb( _PEB_T<T>* ppeb = nullptr ) { return _native->getPEB( ppeb ); }
